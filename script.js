/* ============================================================
   CAROL - Interactive Romantic Webpage
   Complete vanilla JS - No frameworks, no emoji
   ============================================================ */
...
(function () {
  ...
  // ──────────────────────────────────────────────
  // 2. PARTICLE CANVAS (Sakura Petals + Stars + Birds)
  // ──────────────────────────────────────────────
  ...
  function initIntro() {
    ...
    startBtn.addEventListener('click', () => {
      ...
      // Show curtain container and main content
      if (curtainContainer) curtainContainer.style.display = 'block';
      if (mainContent) {
        mainContent.style.display = 'block';
        mainContent.style.opacity = '1';
        // Resize canvas now that elements are visible
        resizeThreadCanvas();
      }
  ...
  // ──────────────────────────────────────────────
  // 5. RED THREAD (scroll-driven canvas)
  // ──────────────────────────────────────────────
  ...
  function initTelephone() {
    ...
    const handleTap = (e) => {
      ...
      // Activate string wave
      if (stringWave) stringWave.classList.add('active');

      // After wave travels, show message
      setTimeout(() => {
  ...
  // ──────────────────────────────────────────────
  // 12. TREE OF WISHES (hold mechanic)
  // ──────────────────────────────────────────────
  ...
  // ──────────────────────────────────────────────
  // 13. LLUVIA DE ESTRELLITAS (Stars)
  // ──────────────────────────────────────────────
  ...
  // ──────────────────────────────────────────────
  // 14. COLUMPIO DE LOS SUENOS (Swing)
  // ──────────────────────────────────────────────
  ...
  // ──────────────────────────────────────────────
  // 16. JARDIN SECRETO (Garden, scroll-driven)
  // ──────────────────────────────────────────────
  ...
  function initGarden() {
    ...
    for (let i = 0; i < numFlowers; i++) {
      ...
      // Random properties for depth and parallax
      ...
      // Random bloom threshold based on height and random factor
  ...
  function initRipple() {
    document.addEventListener('click', (e) => {
      // Don't ripple on buttons or interactive elements
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    // Scroll handler with throttle via rAF
    ...
    const observer = new IntersectionObserver((entries, obs) => {
      entries.forEach(entry => {
        if (entry.isIntersecting) {
          ...
          // Optional: obs.unobserve(entry.target); if you want it to happen only once
        }
      });
    }, observerOptions);
